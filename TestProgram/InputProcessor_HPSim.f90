...
!CHARACTER(len=120) :: VerString='EnergyPlus, Version 1.1.1'      ! String that represents version information
   ...
   !  FullName='SimpleTest.idd'
   !ELSE
   !  FullName=ProgramPath(1:LEN_TRIM(ProgramPath))//'SimpleTest.idd'
     FullName='C:/Users/lab303user/Desktop/GenOpt/Test/SimpleTest.idd'
   !ENDIF
   ...
   WRITE(EchoInputFile,*) ' Processing Data Dictionary (SimpleTest.idd) File -- Start'
   ...
   WRITE(EchoInputFile,*) ' Processing Data Dictionary (SimpleTest.idd) File -- Complete'
   ...
   IF (LEN_TRIM(ProgramPath) == 0) THEN
     FileName='SimpleTest.idf'
   ELSE
     FileName=ProgramPath(1:LEN_TRIM(ProgramPath))//'SimpleTest.idf'
   END IF

   !FileName = 'C:/Users/lab303user/Desktop/GenOpt/Test/tmp-genopt-run-',IterationNum,'/SimpleTest.idf' !"SimpleTest.idf"
